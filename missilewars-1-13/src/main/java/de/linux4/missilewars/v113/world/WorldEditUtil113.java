 ...
 ******************************************************************************/
package de.linux4.missilewars.v113.world;
...
public class WorldEditUtil113 extends WorldEditUtil {

	private final File schematicFolder;
	
	public WorldEditUtil113(File schematicFolder) {
	...
	public void pasteSchematic(String name, Location loc, boolean ignoreAir) {
		try {
			File schematic = new File(this.schematicFolder, name + ".schem");
